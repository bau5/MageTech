...
import com.techmage.magetech.tileentity.pipe.WireLogic.TransferType;
...
public class PowerHelper
{
    ...
    public static boolean sendPowerTo(TileEntityMPWire source, TileEntityMPWire destination)
    {
