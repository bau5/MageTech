...
import com.techmage.magetech.inventory.ContainerCentrifuge;
...
public class GuiCentrifuge extends GuiContainer
{
    ...
    {
        String containerName = StatCollector.translateToLocal(tileEntityCentrifuge.getInventoryName());
    ...
    protected void drawGuiContainerBackgroundLayer(float opacity, int x, int y)
    {
        ...
        int i1 = this.tileEntityCentrifuge.getPowerScale(32);
        this.drawTexturedModalRect (xStart + 17, yStart + 25 + 32 - i1, 177, 63 - i1, 14, i1 + 1);

        if (this.tileEntityCentrifuge.isCentrifuge())
        {
            i1 = this.tileEntityCentrifuge.getCentrifugeProgressScale(24);
