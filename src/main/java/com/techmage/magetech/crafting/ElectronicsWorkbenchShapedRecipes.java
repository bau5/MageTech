...
public class ElectronicsWorkbenchShapedRecipes implements IRecipe
{
    ...
    public ElectronicsWorkbenchShapedRecipes(int par1, int par2, ItemStack[] par3ArrayOfItemStack, ItemStack par4ItemStack)
    {
    ...
    public ElectronicsWorkbenchShapedRecipes func_92100_c()
    {
