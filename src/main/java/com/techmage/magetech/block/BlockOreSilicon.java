...
public class BlockOreSilicon extends BlockMageTech_Tech
{
    ...
    public BlockOreSilicon()
    {
        ...
        this.setBlockName(Names.Blocks.ORESILICON);
    }
    ...
    {
        this.blockIcon = iconRegister.registerIcon (Textures.RESOURCE_PREFIX + Names.Blocks.ORESILICON);
    }

    public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_)
    {
        return ModItems.siliconOre;
    }
