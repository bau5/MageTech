package com.techmage.magetech.tileentity.pipe;

import static com.techmage.magetech.tileentity.pipe.WireLogic.TransferType.UNKNOWN;
import com.techmage.magetech.power.Power.IPowerEmitter;
import com.techmage.magetech.power.Power.IPowerReceiver;
import com.techmage.magetech.power.PowerHelper;
...
{
    private final TileEntityMPWire wire;
    private final ForgeDirection side;
    private int posX, posY, posZ;
    private boolean isFake, modified;
    private TransferType type;

    public WireLogic(TileEntityMPWire wire, ForgeDirection side)
    {
        this.wire = wire;
        this.side = side;
    ...
    public final TileEntityMPWire getWire()
    {
        if (isFake() || !isWire()) return null;
        return (TileEntityMPWire) tileEntityAtSpot();
    }
    ...
    public void sendPowerTo()
    {
        ...
        if (isWire())
        {
            PowerHelper.sendPowerTo(wire, (TileEntityMPWire) tileEntityAtSpot());
        }
    }
    ...
    {
        return tileEntityAtSpot() instanceof TileEntityMPWire;
    }
    ...
    public static WireLogic getLogicForSide(TileEntityMPWire wire, ForgeDirection side)
    {
