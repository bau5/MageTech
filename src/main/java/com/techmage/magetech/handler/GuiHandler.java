...
public class GuiHandler implements IGuiHandler
{
    ...
    public Object getServerGuiElement(int id, EntityPlayer entityPlayer, World world, int x, int y, int z)
    {
        ...
        if (id == GuiID.SOLDERING_STATION.ordinal())
        {
            TileEntitySolderingStation tileEntitySolderingStation = (TileEntitySolderingStation) world.getTileEntity(x, y, z);
            return new ContainerSolderingStation(entityPlayer.inventory, tileEntitySolderingStation);
        }
    ...
    public Object getClientGuiElement(int id, EntityPlayer entityPlayer, World world, int x, int y, int z)
    {
        ...
        {
            TileEntitySolderingStation tileEntitySolderingStation = (TileEntitySolderingStation) world.getTileEntity(x, y, z);
            return new GuiSolderingStation(entityPlayer.inventory, tileEntitySolderingStation);
        }
