package com.techmage.magetech.renderer.model;
...
public class ModelMPWire extends ModelBase
{
    // fields
    ...
    public void render(TileEntity te)
    {
        ...
        if (isPipe(world, x, y - 1, z, x, y, z))
        {
            ...
            renderPower(wirePDown, flag, (TileEntityMPWire) te, x, y - 1, z);
        }
        if (isPipe(world, x, y + 1, z, x, y, z))
        {
            wireUp.render(flag);
            renderPower(wirePUp, flag, (TileEntityMPWire) te, x, y + 1, z);
        }
        if (isPipe(world, x - 1, y, z, x, y, z))
        {
            wireEast.render(flag);
            renderPower(wirePEast, flag, (TileEntityMPWire) te, x - 1, y, z);
        }
        if (isPipe(world, x + 1, y, z, x, y, z))
        {
            wireWest.render(flag);
            renderPower(wirePWest, flag, (TileEntityMPWire) te, x + 1, y, z);
        }
        if (isPipe(world, x, y, z + 1, x, y, z))
        {
            wireNorth.render(flag);
            renderPower(wirePNorth, flag, (TileEntityMPWire) te, x, y, z + 1);
        }
        if (isPipe(world, x, y, z - 1, x, y, z))
        {
            wireSouth.render(flag);
            renderPower(wirePSouth, flag, (TileEntityMPWire) te, x, y, z - 1);
        }
    }

    private void renderPower(ModelRenderer m, float flag, TileEntityMPWire te, int x, int y, int z)
    {
